...
// We should consider that there is no text frame parser.
// That’s why we should check at first if it’s a text frame:
//
...
// Checks if a frame with corresponding ID must be added to a sequence.
